...
( function ( $, window, document, undefined )
{
    var bootstrap_confirm_delete = function ( element, options )
    {
        ...
        this.onDelete = function ( event )
        {
            ...
            {
                $( 'body' ).append( '<div id="bootstrap-confirm-delete-container"><div id="bootstrap-confirm-dialog" class="modal fade"><div class="modal-dialog modal-sm"><div class="modal-content"><div class="modal-body"><p id="bootstrap-confirm-dialog-text"></p></div><div class="modal-footer"><a id="bootstrap-confirm-dialog-delete-btn" type="button" class="btn btn-danger next_btn">Yes</a><button id="bootstrap-confirm-dialog-cancel-delete-btn" type="button" class="btn btn-default back_btn" data-dismiss="modal">Cancel</button></div></div></div></div></div>' );
            }
